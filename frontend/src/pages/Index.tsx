    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-primary/10 rounded-full blur-[100px] animate-float" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={feature.title}
                className="glass rounded-2xl p-8 group hover:neon-glow-sm transition-all duration-500 animate-fade-in"
